...
var queryForecast = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&units=imperial" + "&appid=6b4758acdbe25a3b3e8b792b8978ee96"

if (city != ''){

    $.ajax({
      url: queryCity, queryForecast,
      type: "GET",
      dataType: "jsonp",
